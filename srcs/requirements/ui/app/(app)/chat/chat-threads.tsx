...
// The drawer + recency are the only client concerns; the thread list itself is
// server-resolved (frontend.md §8 — no business logic on the client).
export function ChatThreads({ threads }: Props) {
