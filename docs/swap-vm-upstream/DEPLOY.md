...
The `srcs/requirements/swap-vm/config/constants.json` file stores deployment parameters per chain:
...
- `srcs/requirements/swap-vm/deployments/<network>/` - Organized deployment files per network
