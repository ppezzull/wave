...
- **1D strategy reference tests:** [`test/invariants/DutchAuctionLimitSwapInvariants.t.sol`](../../../srcs/requirements/swap-vm/test/invariants/DutchAuctionLimitSwapInvariants.t.sol)
- **2D strategy reference tests:** [`test/invariants/ConcentrateXYCInvariants.t.sol`](../../../srcs/requirements/swap-vm/test/invariants/ConcentrateXYCInvariants.t.sol)
...
Reference: `../../../srcs/requirements/swap-vm/test/RunLoop.t.sol` (`test_BestRouteSelector_XYC_vs_Pegged`).
